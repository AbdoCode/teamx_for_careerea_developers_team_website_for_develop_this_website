...
$(document).ready(function () {
    'use strict';
    var itemCount = $(".coursesPage .row .col-sm-4 > .activityCourse").length,
    ...
    if (filename2 === "courses.php" || filename2 === "jobs.php") {
        ...
        $(window).scroll(function () {
            var windowTopPos = $(window).scrollTop(),
                ...
                navBottomPos = $('.coursesPage .mainFilterSearch').offset().top + $('.coursesPage .mainFilterSearch').outerHeight();
