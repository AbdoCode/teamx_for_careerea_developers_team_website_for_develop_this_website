...
$(document).ready(function () {
    ...
    $(".add-job #Theoretical .addQ").on('click', function () {
        if (j < 11) {
            $("#Theoretical .allQusetion").append('<div class="question"><label>'+ j +'- </label><input type="text" placeholder="Type Your Question" class="form-control" /><div class="input-group"><span class="input-group-addon" id="basic-addon1">A</span><input type="text" class="form-control"><label><input type="radio" name="rightAnswer" value="'+j+'a"/>Right answer</label></div><div class="input-group"><span class="input-group-addon" id="basic-addon1">B</span><input type="text" class="form-control"><label><input type="radio" name="rightAnswer" value="'+j+'b"/>Right answer</label></div><div class="input-group"><span class="input-group-addon" id="basic-addon1">C</span><input type="text" class="form-control"><label><input type="radio" name="rightAnswer" value="'+j+'c"/>Right answer</label></div><div class="input-group"><span class="input-group-addon" id="basic-addon1">D</span><input type="text" class="form-control"><label><input type="radio" name="rightAnswer" value="'+j+'c"/>Right answer</label></div></div>');
            j++;
        }
    });
});